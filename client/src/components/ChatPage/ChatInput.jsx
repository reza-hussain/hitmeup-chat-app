...
const ChatInput = ({ allMessages, setAllMessages, socket, setTypingStatus}) => {
    ...
    const handleTyping = () => {
      socket.emit('typing', currentRoom.id, socket.id);
    }
    const sendMessage = (e) => {
    ...
    return (
      ...
      <div className="w-full flex justify-start items-center bg-slate-100 mt-auto border border-black absolute bottom-0 z-10" tabIndex="0">
